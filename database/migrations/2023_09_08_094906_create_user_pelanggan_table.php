...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('user_pelanggan', function (Blueprint $table) {
            ...
            $table->string('status_pernikahan_plgn', 200)->nullable();
            $table->string('npwp_plgn', 30)->nullable();
            $table->string('sumber_dana_plgn', 100)->nullable();
            $table->string('tempat_lahir_plgn', 50)->nullable();
            $table->date('tgl_lahir_plgn')->nullable();
            $table->string('jenis_kelamin_status', 100)->nullable();
            $table->string('qr_code_plgn', 100);
