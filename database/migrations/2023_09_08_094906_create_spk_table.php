...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('spk', function (Blueprint $table) {
            ...
            $table->string('file_hasil_spk', 200)->nullable();
            ...
            $table->integer('sisa_spk');
            $table->integer('cicilan_spk');
            $table->enum('status_spk', ['progress', 'selesai', 'pembayaran', 'pengajuan', 'awal', 'pengajuan teknik'])->nullable();
