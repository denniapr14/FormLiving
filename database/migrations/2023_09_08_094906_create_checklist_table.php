...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('checklist', function (Blueprint $table) {
            ...
            $table->integer('id_pengawas1')->nullable()->index('id_pengawas1_3');
            $table->integer('id_pengawas2')->nullable()->index('id_pengawas2');
            ...
            $table->index(['id_pengawas2'], 'id_pengawas2_3');
            $table->index(['id_pengawas2'], 'id_pengawas2_2');
