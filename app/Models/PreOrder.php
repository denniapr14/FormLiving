...
class PreOrder extends Model{
    ...
    function getPreOrderWhereAllArr($select,$where) {
        return PreOrder::select($select)
        ->where($where)
        ->get();
    }
    ...
    function getPreOrderWhereAllOrderByJoinProjekUserRumahClusterPelangganKategoriUserArr($select,$where,$order,$by) {
        return PreOrder::select($select)
        ->join('user_admin','pre_order.id_user_admin','=','user_admin.id_user_admin')
        ->join('ktgr_admin','user_admin.id_kategori','=','ktgr_admin.id_kategori')
        ->join('rumah','pre_order.id_rumah','=','rumah.id_rumah')
