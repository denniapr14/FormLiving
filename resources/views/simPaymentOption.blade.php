...
<div class="cluster">
                                    ...
                                    <div id="collapse-card-cluster" class="card-body collapse-item">
                                        <div class="row">
                                            <form
                                                ...
                                                <br>
                                                <div>
                                                    <label for="">Persentase Uang Muka <input type="checkbox" name=""
                                                            id="RupiahCheck"> Rupiah </label>
                                                </div>
                                                <div class="">
                                                    <div class="form-group">
                                                ...
                                                <div class="card-shadow">
                                                    ...
                                                    <div class="">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form form-control" id="jumlahKPR"
                                                                name="jumlah" readonly hidden
                                                ...
                                                <div class="">
                                                    <div class="form-group">
                                                        <select name="cicilanUM" id="cicilanUM" required
                                                            ...
                                                            @for ($i = 1; $i < $cicilan; $i++) <option value="{{ $i }}">
                                                                {{ $i }} kali
                                                                </option>
                                                                @endfor
                                                        </select>
                                            ...
                                            <form
                                                ...
                                                <div class="simulation-price">
                                                    ...
                                                    <div class="card-shadow">
                                                        ...
                                                        <input type="text" name="jenis" value="Cicilan" readonly hidden
                                                            id="">
                                                    ...
                                                    <div class="collapse-item" id="cicilan">
                                                        @for ($i = 1; $i <= 8; $i++) <?php $thn=($tipeRumah->harga_tr -
                                                            10000000) / $i;
                            ...
                            <div class="row " style="width: 100%">
                                ...
                                <div class="promo-button col-md-2">
                                    ...
                                    <a class="promoCodeBtn btn btn-outline-success"
                                        ...
                                        data-freeppn-promo="{{ $promoRumah->free_ppn_promo }}">{{
                                        $promoRumah->kode_promo }}
    ...
    <script>
        ...
        const promoCodeBtns = document.querySelectorAll(".promoCodeBtn");
            ...
            var promoCode, jenisPromo, statusDiskon, diskonPromo, statusMaxDiskon, maxDiskon, promo,bphtbPromo,freeKPRPromo,freePPNPromo;
        ...
        success: function(response) {
            ...
            if (response.promo != null) {
                ...
                if (response.jenis_promo == "KPR") {
                    ...
                    CekPromo("KPR", response.status_diskon, response.diskon_promo, response.status_max_diskon, response.max_diskon);
                    console.log(CekPromo("KPR", response.status_diskon, response.diskon_promo, response.diskon_promo, response.diskon_promo));
