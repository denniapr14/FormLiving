...
@extends('MainLayout.navbar')
@extends('MainLayout.footer')
@section('tittle', 'FORMS | Welcome')
...
<div class="offcanvas offcanvas-end sidebar" tabindex="-1" id="sidebar" aria-labelledby="sidebar">
    ...
    <div class="offcanvas-body">
            ...
            <ul>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <li>
                            <a class="dropdown-item" href="/greenland.html">
                                <div>
                                    <img src="{{url('Main')}}/images/logo-tidar-green.png" alt="">
                                    <p>Greenland</p>
                                </div>
                            </a>
                        </li>
                        ...
                        <li>
                            <a class="dropdown-item" href="#">
                                <div>
                                    <img src="{{url('Main')}}/images/logo-project3b.png" alt="">
                                    <p>Project C</p>
                                </div>
                            </a>
                        </li>
                        <li>
                            <a class="dropdown-item" href="#">
                                <div>
                                    <img src="{{url('Main')}}/images/logo-project4.png" alt="">
                                    <p>Project D</p>
                                </div>
                            </a>
                        </li>
                        <li>
                            <a class="dropdown-item" href="#">
                                <div>
                                    <img src="{{url('Main')}}/images/logo-project5.png" alt="">
                                    <p>Project E</p>
                                </div>
                            </a>
                        </li>
        ...
        <div class="action">
            <a href="/login.html" type="button" class="btn btn-outline-secondary">Login/Register</button>
                <a href="/my-cart.html">
                    <img src="{{url('Main')}}/images/ic-cart.png" alt="">
                </a>
        </div>
    </div>
</div>
        ...
        <div class="row align-items-center">
            <div class="col-12 col-lg-6 cta-text mb-4 mb-lg-0">
                ...
                <div class="actions" data-aos="fade-right" data-aos-delay="600">
                    ...
                    <button type="button" class="btn btn-blank-primary"><img src="{{url('Main')}}/images/ic-play-fill.png" alt="">
                ...
                <div class="sponsor" data-aos="fade-right" data-aos-delay="600" data-aos-offset="0">
                    ...
                    <div class="logos">
                        <div class="item">
                            <img src="{{url('Main')}}/images/logo-tidar-gray.png" alt="">
                        </div>
                        <div class="item">
                            <img src="{{url('Main')}}/images/logo-project2b.png" alt="">
                        </div>
            ...
            <div class="col-12 col-lg-6 cta-img pe-0" data-aos="fade-left" data-aos-delay="400">
                <div class="image-sliders">
                    <div>
                        <img src="{{url('Main')}}/images/img-splash-screen.png" class="w-100" alt="">
                    </div>
                    <div>
                        <img src="{{url('Main')}}/images/img-cluster-large1.png" class="w-100" alt="">
                    </div>
                    <div>
                        <img src="{{url('Main')}}/images/img-cluster-large2.png" class="w-100" alt="">
                    </div>
                </div>
        ...
        <div class="container">
            <div class="sliders-mobile">
                <a href="/greenland.html" class="item">
                    <div class="logo">
                        <img src="{{url('Main')}}/images/logo-tidar-white.png" alt="">
                    </div>
                    <div class="item-img">
                        <img src="{{url('Main')}}/images/mobile-sliders1.png" alt="">
                    </div>
                ...
                <div class="item">
                    ...
                    <div class="item-img">
                        <img src="{{url('Main')}}/images/img-greenland2.png" alt="">
                    </div>
                    <div class="float-button">
                        Miliki Unit <i class="bi-chevron-right"></i>
                    </div>
            ...
            <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active" id="semua-tab-pane" role="tabpanel"
                    ...
                    <div class="units">
                        <a href="/greenland.html" class="item">
                            <div class="item-img">
                                <img src="{{url('Main')}}/images/img-greenland.png" alt="">
                            </div>
                            <h6>Greenland</h6>
                        ...
                        <a href="#" class="item">
                            <div class="item-img">
                                <img src="{{url('Main')}}/images/img-apartement.png" alt="">
                            </div>
                            <h6>Austinville</h6>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. </p>
                        </a>
                        <a href="/greenland.html" class="item">
                            <div class="item-img">
                                <img src="{{url('Main')}}/images/img-hotel.png" alt="">
                            </div>
                            <h6>Project B</h6>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. </p>
                        </a>
                ...
                <div class="tab-pane fade" id="perumahaan-tab-pane" role="tabpanel" aria-labelledby="perumahaan-tab"
                    tabindex="0">
                    <div class="no-unit">
                        <img src="{{url('Main')}}/images/img-illustration5.svg" alt="">
                    </div>
                </div>
...
<div class="projects">
    <div class="container">
        ...
        <div class="row items">
            ...
            <div class="col-12 col-lg-6">
                <div class="item" data-aos="fade-left">
                    <img src="{{url('Main')}}/images/img-mall.png" alt="">
                    <div class="item-text">
                        <h4>Project D</h4>
                        <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Expedita impedit quas at
                            inventore,
    ...
    <div class="sliders">
        <div class="slider-item">
            <div class="slider-img">
                <img src="{{url('Main')}}/images/slider-1.png" class="w-100" alt="">
            </div>
        ...
        <div class="row items">
            <div class="col-12 col-sm-6 col-lg-4 mb-3 mb-lg-0">
                <div class="item brown">
                        ...
                        <div class="text-cashback">
                            ...
                            <div class="mobile-only">
                                ...
                                <button type="button" class="btn btn-white">Salin Kode <img class="ms-2"
                                        src="{{url('Main')}}/images/ic-copy.png" alt=""></button>
                            </div>
                        </div>

                        <div class="bg-cashback">
                            <img src="{{url('Main')}}/images/img-promo.png" alt="">
                        </div>
                    ...
                    <div class="line">
                        <img src="{{url('Main')}}/images/line-coupon.png" alt="">
                    </div>
                    <div class="qr">
                        <div class="qr-img">
                            <img src="{{url('Main')}}/images/qr-code.png" alt="">
                        </div>
...
<div class="apps" data-aos="fade-up" data-aos-offset="0">
    <div class="container">
        <div class="ornament one">
            <img src="{{url('Main')}}/images/img-ornament3.png" alt="">
        </div>
        <div class="ornament two">
            <img src="{{url('Main')}}/images/img-ornament1.png" alt="">
        </div>
        <div class="row">
            <div class="col-5 col-lg-6">
                <div class="apps-preview">
                    <div class="first">
                        <img src="{{url('Main')}}/images/phone-1.png" alt="">
                    </div>
                    <div class="second">
                        <img src="{{url('Main')}}/images/phone-2.png" alt="">
                    </div>
                </div>
            </div>
            ...
            <div class="col-7 col-lg-6">
                ...
                <div class="logos">
                    <div class="me-3">
                        <img src="{{url('Main')}}/images/img-app-store.png" alt="App Store">
                    </div>
                    <div>
                        <img src="{{url('Main')}}/images/img-google-play.png" alt="Google Play">
                    </div>
                </div>
            </div>
        </div>
