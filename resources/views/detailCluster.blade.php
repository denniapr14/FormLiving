                ...
                <div class="col-12 col-lg-3 image-right">
                    <div class="row">
                        <div class="col-4 col-lg-12 mb-0 mb-lg-4">
                            <img src="{{ asset('Home') }}/images/img-detailcluster1.png" alt="">
                        </div>
                        <div class="col-4 col-lg-12 mb-0 mb-lg-4">
                            <img src="{{ asset('Home') }}/images/img-detailcluster2.png" alt="">
                        </div>
                        <div class="col-4 col-lg-12 mb-0 mb-lg-4">
        ...
        <div class="content">
            ...
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="desktop-only">
                    <a href="/simulation-cluster" type="button" class="btn btn-primary">Miliki Unit Ini</a>
                </div>
            </div>
            <hr>
            ...
            <div class="mobile-only">
                <div class="content-footer">
                    ...
                    <div>
                        <a href="/simulation-cluster" type="button" class="btn btn-primary">Miliki Unit
                            Ini</a>
                    </div>
                </div>
            </div>
