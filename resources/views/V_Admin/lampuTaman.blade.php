@extends('V_Admin.app')
@extends('flashdata')
@section('title', 'Form One | Laporan Harian Lampu Taman')
@section('pageTitle', 'Laporan Harian Lampu Taman')
            ...
            <div class="card">
                <a class="card-header" id="heading11">
                    <button class="btn btn-link" data-toggle="collapse" data-target="#harianLampu" aria-expanded="true" aria-controls="collapse1">
                        <h5 class="m-b-0">Laporan Lampu Taman Hari ini</h5>
                    </button>
                </a>
            ...
            <div class="card">
                <a class="card-header" id="heading11">
                    <button class="btn btn-link" data-toggle="collapse" data-target="#Lampu" aria-expanded="true" aria-controls="collapse1">
                        <h5 class="m-b-0">Laporan Lampu Taman</h5>
                    </button>
                </a>
