...
<div class="">
    ...
    <div class="card mb-3">
        <div class="card-body">
                            ...
                            <div class="float-right">
                                ...
                                <a href="#" data-toggle="modal" data-target="#addChecklist"
                                    class="btn btn-outline-info btn--small" style="float: right"><i class="fa fa-plus"
                                        aria-hidden="true"></i> Checklist</a>
                                ...
                                <div class="modal" id="addChecklist">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <form action="{{ route('addChecklist.admin', $getProjek->nama_projek) }}"
                                                method="POST">
                                                @csrf
                                                <!-- Modal Body -->
                                                <div class="modal-body">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="js-example-basic-single form-control" id="rumah"
                                                            required name="rumah" style="width: 100%">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="subkon" required
                                                            class="js-example-basic-single form-control" id=""
                                                            style="width: 100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @if ($checklist->percentase < 25) <div class="progress">
            ...
            @elseif($checklist->percentase > 25 && $checklist->percentase < 50) <div class="progress">
                <div class="progress-bar bg-warning progress-bar-striped" role="progressbar"
                    aria-valuenow="{{ $checklist->percentase }}" aria-valuemin="0" aria-valuemax="100"
                    style="width: {{ $checklist->percentase }}%">

                </div>
        </div>
        @elseif($checklist->percentase > 50 && $checklist->percentase < 75) <div class="progress">
    ...
    <td>
        ...
        @elseif ($checklist->tgl_deadline > $newdt && $checklist->tgl_deadline < $newdtr) <div
...
<td>
    ...
    <a href="{{ route('nextTermin.admin', [$getProjek->nama_projek, Crypt::encrypt($checklist->id_rumah)]) }}"
        class="btn btn-outline-info"><i class="fa fa-chevron-right" aria-hidden="true"> Termin</i></a><br>


    <a href="#" class="btn btn-outline-info" data-toggle="modal" data-target="#dateModal">
        Costum Deadline
    </a>

    <div class="modal fade" id="dateModal" tabindex="-1" role="dialog" aria-labelledby="pinModalLabel"
        aria-hidden="true">
                ...
                <form
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" name="tanggalTermin" class="form-control" id="dateInput">
                        </div>
