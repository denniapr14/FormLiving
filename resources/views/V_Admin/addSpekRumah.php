    ...
    <div class="card__box">
      <div class="card__header">
        <div class="card__title">
          ...
          <a href="{{  route('tipeRumah.admin',[$getProjek->nama_projek,Crypt::encrypt($getTipeRumah->id_rumah)] ) }}"
            class="btn-fd-icon-outline " style="height: 40px;width: 50px"> <i class="bi bi-arrow-left"></i></a>
          <h4> Tambah Spesifikasi Rumah</h4>
      ...
      <form
        ...
        <div class="form-group">
          ...
          <input type="text" name="pondasi[]" id="" value="{{ $getTipeRumah->pondasi_tr }}" class="form-control"
        ...
        <div class="form-group">
          ...
          <input type="text" name="penutupAtap[]" id="" class="form-control"
            value="{{ $getTipeRumah->penutup_atap_tr }}" placeholder="Masukan Pentutup Atap" aria-describedby="helpId">
        ...
        <div class="form-group">
          ...
          <input type="text" name="sanitary[]" value="{{ $getTipeRumah->sanitary_tr }}" id="" class="form-control"
        ...
        <div class="form-group">
          ...
          <input type="text" name="lighting[]" id="" value="{{ $getTipeRumah->lighting_tr }}" class="form-control"
        ...
        <div class="form-group">
          ...
          <input type="text" name="dayaListrik[]" id="" class="form-control"
            value="{{ $getTipeRumah->daya_listrik_tr }}" placeholder="Masukan Daya Listrik" aria-describedby="helpId">

        </div>
        <div class="form-group">
          <label for="">Carport</label>
          <input type="text" name="carport[]" id="" value="{{ $getTipeRumah->carport_tr }}" class="form-control"
              ...
              <div class="card-body">
                ...
                <div class="product-listing">
                  ...
                  <div class="product__item">
                    ...
                    <div class="product__card">
                      ...
                      <div class="product__img">
                        <img src="{{ url('Home') }}/images/denah/{{ $gambar->img_rumah }}" alt="product-1"
                          id="denah{{ $gambar->id_gambar_rumah }}">
                      </div>
                      <p> {{ $gambar->jenis_img }}</p>
                      @if ($gambar->status_gr != 'nonaktif')
                      <a href="/gambar-rumah/status/nonaktif/{{ Crypt::encrypt($gambar->id_gambar_rumah) }}"
                        class="btn btn-danger"><i class="fa fa-toggle-off" aria-hidden="true"></i> Nonaktif</a>
                      @else
                      <a href="/gambar-rumah/status/aktif/{{ Crypt::encrypt($gambar->id_gambar_rumah) }}"
                        class="btn btn-primary"><i class="fa fa-toggle-on" aria-hidden="true"></i> Aktif</a>
                      @endif

                      <button type="button" class="btn btn-info" data-target="#tipeRumah{{ $gambar->id_gambar_rumah }}"
                        data-toggle="modal" data-target=".bd-example-modal-lg{{ $gambar->id_gambar_rumah }}">
                  ...
                  <div class="product__item">
                    <div class="product__card">
                      <div class="product__img">
                        <img src="{{ url('Home') }}/images/tipe/{{ $gambar->img_rumah }}" alt="product-1"
                          id="gambar{{ $gambar->id_gambar_rumah }}">
                      </div>
                      <p> {{ $gambar->jenis_img }}</p>
                      @if ($gambar->status_gr != 'nonaktif')
                      <a href="/gambar-rumah/status/nonaktif/{{ Crypt::encrypt($gambar->id_gambar_rumah) }}"
                        class="btn btn-danger"><i class="fa fa-toggle-off" aria-hidden="true"></i>
                        Nonaktif</a>
                      @else
                      <a href="/gambar-rumah/status/aktif/{{ Crypt::encrypt($gambar->id_gambar_rumah) }}"
                        class="btn btn-primary"><i class="fa fa-toggle-on" aria-hidden="true"></i>
                        Aktif</a>
                      @endif
                      <button type="button" class="btn btn-info" data-target="#tipeRumah{{ $gambar->id_gambar_rumah }}"
                        data-toggle="modal" data-target=".bd-example-modal-lg{{ $gambar->id_gambar_rumah }}">
                  ...
                  <div class="modal-body">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-8 align-self-center">
                        <input type="file" class="form-control" name="img" placeholder="masukan gambar"
                    ...
                    <div class="row pt-4">
                      <div class="col-12">
                        ...
                        <button class="btn btn-primary w-100 mb-1" type="button" name="submitImg"
                          id="uploadButton{{ $gambar->id_gambar_rumah }}">Submit</button>
                        <button class="btn btn-danger w-100" type="" data-dismiss="modal">Close</button>
                ...
                <form enctype="multipart/form-data" id="imageUploadForm">
                  ...
                  <div class="modal-body">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-8 align-self-center">
                        <input type="file" class="form-control" name="img" placeholder="masukan gambar" id="img">
                      </div>
