            ...
            <div class="card__box">
                <div class="card__header">
                    <div class="card__title">
                        <a href="{{ route('tipeRumah.admin',[$getProjek->nama_projek,Crypt::encrypt($getTipeRumah->id_rumah)] ) }}" class="btn-fd-icon-outline col-1" style="height: 40px; width: 50px"> <i class="bi bi-arrow-left"></i></a> &nbsp;
