                                        ...
                                        <table style="border-collapse:collapse;margin-left:38.524pt" cellspacing="0">
                                            ...
                                            <tr style="height:16pt">
                                                ...
                                                <td style="width:86pt">
                                                    <p class="s2"
                                                        style="padding-right: 5pt;text-indent: 0pt;line-height: 13pt;text-align: right;">
                                                        {{ rupiah((11 / 100) * (($getFormulirPesanan->total_harga + 3000000) / 1.16)) }},-
                                                    </p>
                                                </td>
                                            </tr>
                                            <tr style="height:16pt">
                                                ...
                                                <td style="width:29pt">
                                                    <p class="s2"
                                                        style="padding-left: 3pt;text-indent: 0pt;text-align: left;">Rp.
                                                    </p>
                                                </td>
                                                <td style="width:86pt">
                                                    <p class="s2"
                        ...
                        <ol id="l2">
                            <li data-list-text="I.">
                                <p style="padding-left: 41pt;text-indent: -20pt;line-height: 114%;text-align: left;">
                                    ...
                                    puluh)
                                    hari
                                    sejak tanggal Surat Pemesanan ini. Apabila setelah lewatnya jangka waktu tersebut, maka
                                    PT.
                                    CITRA
                                    ARGO
                                    ...
                                    pembayaran
                                    yang
                                    telah dilakukan pemesan tidak dapat dituntut kembali atau ditarik dari PT. CITRA ARGO
                                    TIRTA.
                                </p>
                            </li>
                            <li data-list-text="II.">
                                <p style="padding-left: 41pt;text-indent: -23pt;line-height: 114%;text-align: left;">Dalam
                                    hal
                                    pemesan
                                ...
                                <p style="padding-left: 41pt;text-indent: 0pt;line-height: 114%;text-align: left;">
                                    permohonan
                                    fasilitas
                                    kredit sebagaimana butir X di bawah, Maka seluruh pembayaran yang telah dilakukan
                                    pemesan
                                    tidak
                                    dapat
                            ...
                            <li data-list-text="III.">
                                <p style="padding-left: 41pt;text-indent: -25pt;line-height: 114%;text-align: left;">Untuk
                                    ...
                                    oleh
                                    PT.
                                    CITRA ARGO TIRTA, pemesan wajib terlebih dahulu membayar seluruh bea/pajak dan biaya
                                    yang
                                    belum
                                    termasuk
                            ...
                            <li data-list-text="IV.">
                                <p style="padding-left: 41pt;text-indent: -26pt;line-height: 114%;text-align: left;">
                                    Sebelum
                                ...
                                <ol id="l3">
                                    ...
                                    <li data-list-text="b.">
                                        <p
                                            ...
                                            kenaikan
                                            tarif
                                            Nilai Jual Obyek Pajak (NJOP) dimana Pajak Penghasilan (PPh) yang menjadi
                                            kewajiban
                                            PT.
                                            CITRA
                                            ARGO TIRTA menjadi lebih besar dari PPh yang telah dibayarkan oleh PT. CITRA
                                            ARGO
                                            TIRTA
                                            berdasarkan Harga Tanah dan Bangunan/Kavling dalam Surat Pemesanan ini, sejauh
                                            hal
                                            tersebut
                            ...
                            <li data-list-text="V.">
                                <p style="padding-left: 41pt;text-indent: -27pt;line-height: 114%;text-align: left;">Dalam
                                    hal
                                    pemesan
                                    belum membayar seluruh pajak/bea dan biaya sebagaimana butir III sebelum dilaksanakannya
                                    penandatanganan
                                    AJB PPAT, maka PT. CITRA ARGO TIRTA tidak wajib melaksanakan penandatanganan AJB PPAT,
                                    dan
                                    segala
                                    risiko
                            ...
                            <li data-list-text="VI.">
                                <p style="padding-left: 41pt;text-indent: -29pt;line-height: 114%;text-align: justify;">
                                    Apabila
                                    pemesan
                                    lalai dalam hal kurang atau terlambat melakukan suatu pembayaran berdasarkan Surat
                                    Pemesanan
                                    ini,
                                    maka
                            ...
                            <li data-list-text="VII.">
                                <p style="padding-left: 41pt;text-indent: -32pt;line-height: 114%;text-align: left;">Selain
                                    ...
                                    membatalkan
                                    Surat
                                    Pemesanan ini sesuai butir XI di bawah, dan seluruh pembayaran yang telah dilakukan
                                    pemesan
                                    tidak
                                    dapat
                                    dituntut kembali atau ditarik dari PT. CITRA ARGO TIRTA.</p>
                            ...
                            <li data-list-text="VIII.">
                                <p style="padding-left: 41pt;text-indent: -35pt;line-height: 114%;text-align: left;">Untuk
                                    setiap
                                    pembayaran, apabila ternyata cek/giro atau pengiriman/transfer yang ditolak oleh Bank,
                                    maka
                                    pemesan
                                    dikenakan dan wajib membayar kepada PT. CITRA ARGO TIRTA biaya administrasi sebesar Rp.
                                    100.000,-
                                    (seratus ribu rupiah) per setiap kejadian dan berlaku pula ketentuan butir IX dan butir
                                    X.
                                </p>
                            </li>
                            <li data-list-text="IX.">
                                <p style="padding-left: 41pt;text-indent: -29pt;line-height: 13pt;text-align: left;">
                                    Pembayaran
                                    kepada
                                    PT.
                                ...
                                <ol id="l4">
                                    <li data-list-text="a.">
                                        ...
                                        <p style="padding-top: 2pt;padding-left: 77pt;text-indent: 0pt;text-align: left;">
                                            ...
                                            Nama : PT
                                            CITRA ARGO TIRTA</p>
                                        <p style="padding-top: 1pt;padding-left: 77pt;text-indent: 0pt;text-align: left;">
                                            Nomor
                                            Rekening
                                            :
                                    ...
                                    <li data-list-text="b.">
                                        <p
                                            ...
                                            rekening atas
                                            nama suami/istri/anak harus dibuktikan dengan dokumen legalitas yang berupa
                                            Kartu
                                            Keluarga,
                                            Akta
                            ...
                            <li data-list-text="X.">
                                <p style="padding-left: 41pt;text-indent: -26pt;text-align: left;">PENGURUSAN FASILITAS
                                    KREDIT
                                    MELALUI
                                ...
                                <ol id="l5">
                                    <li data-list-text="a.">
                                        <p
                                            style="padding-top: 1pt;padding-left: 77pt;text-indent: -18pt;text-align: left;">
                                            Pemesan
                                            wajib
                                        ...
                                        <p
                                            ...
                                            Keuangan/Pembiayaan selambat-lambatnya : 7 (Tujuh) Hari setelah tanda jadi
                                            (booking
                                            fee)
                                            untuk KPR PERTAMA, KEDUA, KETIGA, KEEMPAT dan KELIMA 3 (tiga) bulan sebelum DP
                                            Lunas
                                            untuk
                                            KPR
                                        ...
                                        <p style="padding-left: 77pt;text-indent: 0pt;line-height: 114%;text-align: left;">
                                            seterusnya
                                            dengan cicilan Uang Muka (DP) lebih dari 3 (tiga) bulan. Apabila lewat dari
                                            waktu
                                            tersebut,
                                    ...
                                    <li data-list-text="b.">
                                        <p
                                            style="padding-top: 2pt;padding-left: 77pt;text-indent: -18pt;line-height: 114%;text-align: left;">
                                            Apabila pemesan tidak memenuhi undangan untuk wawancara, dan/atau apabila
                                            pemesan
                                            sudah
                                            mendapatkan persetujuan kredit dari Bank/Lembaga Keuangan/Pembiayaan namun belum
                                            melakukan
                                            akad
                                            kredit dengan Bank/Lembaga Keuangan/Pembiayaan dihadapan Notaris, dan PT. CITRA
                                            ARGO
                                            TIRTA,
                                            telah melakukan pemberitahuan sebanyak 3 (tiga) kali, baik lisan maupun
                                            tertulis,
                                            maka
                                            pemesan
                                    ...
                                    <li data-list-text="c.">
                                        <p
                                            style="padding-top: 2pt;padding-left: 77pt;text-indent: -18pt;text-align: left;">
                                            Apabila
                                            setelah
                                        ...
                                        <p
                                            ...
                                            pemesan telah diberikan, ternyata pemesan harus menambah/membayar Uang Muka,
                                            maka
                                            pemesan
                                            wajib
                                        ...
                                        <p
                                            style="padding-left: 77pt;text-indent: 0pt;line-height: 114%;text-align: justify;">
                                            Keuangan/Pembiayaan tersebut. Apabila lewat dari dalam jangka waktu tersebut,
                                            maka
                                            PT. CITRA
                                        ...
                                        <ol id="l6">
                                            <li data-list-text="i.">
                                                ...
                                                <p style="padding-left: 113pt;text-indent: 0pt;text-align: left;">
                                                    pelaksanaan
                                                    akad
                                                    kredit,atau</p>
                                            </li>
                                    ...
                                    <li data-list-text="d.">
                                        ...
                                        <p
                                            ...
                                            dibayarkan
                                            oleh
                                            pemesan kepada PT. CITRA ARGO TIRTA akan dikembalikan dengan syarat pemesan
                                            wajib
                                            mengembalikan
                                            kepada PT. CITRA ARGO TIRTA Asli Surat Pemesanan ini dan seluruh</p>
                                        <p style="padding-left: 77pt;text-indent: 0pt;line-height: 113%;text-align: left;">
                                            Asli
                                            kwitansi
                                        ...
                                        <ol id="l7">
                                            <li data-list-text="i.">
                                                <p
                                                    style="padding-left: 113pt;text-indent: -14pt;line-height: 114%;text-align: left;">
                                                    Tanda
                                                    jadi (booking fee) dan pajak - pajak yang sudah disetor ke negara untuk
                                                    KPR
                                                    PERTAMA,
                                    ...
                                    <li data-list-text="e.">
                                        ...
                                        <p style="padding-left: 77pt;text-indent: 0pt;line-height: 114%;text-align: left;">
                                            Pegawai
                                            Negeri
                                            Sipil Departemen Pertahanan (YKPP DEPHAN) atau Badan Pertimbangan Tabungan
                                            Perumahan
                                            Pegawai
                                        ...
                                        <p style="padding-left: 77pt;text-indent: 0pt;line-height: 114%;text-align: left;">
                                            bertanggung
                                            jawab atas pelunasan pembayaran Uang Muka tersebut kepada PT. CITRA ARGO TIRTA
                                            jika
                                        ...
                                        <p
                                            ...
                                            maka PT.
                                            CITRA
                                            ARGO TIRTA berhak membatalkan Perjanjian ini sesuai butir XI dibawah dan uang
                                            yang
                                            sudah
                                            dibayarkan oleh pemesan kepada PT. CITRA ARGO TIRTA akan dikembalikan dengan
                                            syarat
                                            pemesan
                                            mengembalikan kepada PT. CITRA ARGO TIRTA asli Surat Pemesanan ini dan seluruh
                                            asli
                                            kwitansi
                                            pembayaran terkait. Seluruh pengembalian tersebut tanpa</p>
                                        <p
                                            style="padding-left: 77pt;text-indent: 0pt;line-height: 113%;text-align: justify;">
                                            diberikan
                            ...
                            <li data-list-text="XI.">
                                <p style="padding-left: 41pt;text-indent: -29pt;text-align: justify;">Untuk pembatalan
                                    Surat
                                    Pemesanan
                                    ini,
                                ...
                                <p
                                    ...
                                    melepaskan ketentuan ketentuan Pasal 1265, 1266, 1267 Kitab Undang-Undang Hukum Perdata
                                    dan
                                    pemesan
                                    ...
                                    CITRA ARGO
                                    TIRTA mengirim surat pembatalannya kepada pemesan, tanpa perlu melalui proses Pengadilan
                                    dan
                                    berlaku
                                    terhitung tanggal pengiriman surat pembatalan tersebut oleh PT.</p>
                                <p style="padding-left: 41pt;text-indent: 0pt;line-height: 114%;text-align: left;">CITRA
                                    ARGO
                                    TIRTA yang
                                    dibuktikan dengan tanda terima yang dikeluarkan oleh kantor pos/perusahaan jasa
                                    kurir/kurir.
                                </p>
                            </li>
                            <li data-list-text="XII.">
                                <p style="padding-left: 41pt;text-indent: -32pt;text-align: justify;">KETENTUAN PINDAH BLOK
                                    DAN
                                    NOM0R
                                    TANAH
                                    BESERTA BANGUNAN</p>
                                <ol id="l8">
                                    <li data-list-text="a.">
                                        <p
                                            ...
                                            Pemindahan Blok/Kavling oleh PT. CITRA ARGO TIRTA karena perubahan peruntukan
                                            blok
                                            atau
                                            karena
                                        ...
                                        <ol id="l9">
                                            <li data-list-text="i.">
                                                <p
                                                    ...
                                                    Harus mengajukan surat permohonan pindah Blok/ Kavling dan disetujui
                                                    oleh
                                                    PT. CITRA
                                                    ARGO
                                                    TIRTA.</p>
                                            ...
                                            <li data-list-text="iii.">
                                                <p
                                                    ...
                                                    dikurangi
                                                    nilai
                                                    PPN dan PPh atas jumlah pembayaran yang telah dilakukan pemesan kepada
                                                    PT.
                                                </p>
                                                <p
                                            ...
                                            <li data-list-text="v.">
                                                <p
                                                    ...
                                                    pada
                                                    saat
                                                    pemesanan, dan harga Tanah dan Bangunan/ Kavling yang baru
                                                    diperhitungkan
                                                    dari harga
                            ...
                            <li data-list-text="XIII.">
                                <p style="padding-left: 41pt;text-indent: -34pt;text-align: left;">KETENTUAN PENGALIHAN
                                    HAK,
                                    KEWAJIBAN
                                    DAN
                                ...
                                <ol id="l10">
                                    ...
                                    <li data-list-text="d.">
                                        <p
                                            ...
                                            Pemesan
                                            wajib
                                            membayar biaya administrasi pengalihan hak sebesar 2.5% (dua koma lima persen)
                                            dari
                                            harga
                                            jual
                                    ...
                                    <li data-list-text="e.">
                                        <p
                                            ...
                                            Pemesan
                                            wajib
                                            membayar biaya (PPh) final sebesar 2.5% (satu persen) dari Harga Tanah dan
                                            Bangunan
                                            berdasarkan
                                            perjanjian ini atau Nilai Jual Objek Pajak (NJOP) PBB Tahun berjalan,
                                            diperhitungkan
                                            nilai
                                            tertinggi.</p>
                                    </li>
                                    <li data-list-text="f.">
                                        <p
                                            ...
                                            Khusus
                                            untuk
                                            mengganti nama ke atas nama pihak keluarga, hanya terbatas pada hubungan: orang
                                            tua,
                                            istri/suami
                                            dengan harta campur, anak kandung yang dapat dibuktikan secara hukum dengan:
                                            akta
                                            kelahiran,
                                        ...
                                        <p
                                            style="padding-left: 77pt;text-indent: 0pt;line-height: 114%;text-align: justify;">
                                            cukup oleh
                                            PT. CITRA ARGO TIRTA, maka pemesan wajib membayar kepada PT. CITRA ARGO TIRTA
                                            biaya
                                            administrasi
                                    ...
                                    <li data-list-text="g.">
                                        <p
                                            ...
                                            Pemesan
                                            dan/
                                            atau PIHAK KETIGA tersebut, secara sendiri-sendiri maupun bersama-sama
                                            bertanggung
                                            jawab
                                            atas
                                            segala kewajiban perpajakan yang mungkin timbul dari pengalihan hak tersebut.
                                        </p>
                                    </li>
                                    <li data-list-text="h.">
                                        <p
                                    ...
                                    <li data-list-text="i.">
                                        <p
                                            style="padding-left: 76pt;text-indent: -17pt;line-height: 114%;text-align: left;">
                                            Menandatangani
                                            dan menyerahkan seluruh akta, perjanjian, surat, formulir, dan dokumen lainnya
                                            yang
                        ...
                        <table style="width: 100%">
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p style="text-indent: 0pt;text-align: left;"><br /></p>
                                    <p style="text-indent: 0pt;text-align: left;"><br /></p>
                                    <p style="padding-left: 89pt;text-indent: 0pt;text-align: center;">
                                        {{ $getFormulirPesanan->nama_plgn }}
                                    </p>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <p style="padding-top: 2pt;padding-left: 89pt;text-indent: 0pt;text-align: center;">CEO
                                    </p>
                                    <p style="text-indent: 0pt;text-align: left;"><br /></p>
                                    <p style="text-indent: 0pt;text-align: left;"><br /></p>
