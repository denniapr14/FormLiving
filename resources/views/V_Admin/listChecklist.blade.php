                    ...
                    <table style="width: 100%">
                        <tr>
                            <td> <i class="bi bi-map"></i>
                                <a href="{{ route('getTerminChecklist.admin', [$getProjek->nama_projek, Crypt::encrypt($getRumah->id_rumah)]) }}"
                        ...
                        <tbody>
                            ...
                            @foreach ($getChecklist as $checklist)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div id="accordian-3">
                                            <div class="card">
                                                <a class="card-header" id="heading11">
                                                    ...
                                                    @if ($checklist->id_pengawas1 == $user->id_user_admin)
                                                        @if ($checklist->status_cek_pengawas1 == 'belum selesai')
                                                            <span class="btn btn-outline-warning float-right"> <i
                                                                    class="fas fa-spinner fa-spin"></i> </span>
                                                        @else($checklist->status_cek_pengawas1 == "selesai")
                                                            <span class="btn btn-outline-success float-right"> <i
                                                ...
                                                <div id="collapseDetail{{ $no }}" class="collapse"
                                                    ...
                                                    <div class="card-body">
                                                        <p>
                                                            Pengawas 1 : {{ $checklist->pengawas1 }} @if ($checklist->status_cek_pengawas1 == 'selesai')
                                                                <span class="btn btn-outline-success"><i class="fa fa-check"
                                            ...
                                            <div class="card">
                                                <a class="card-header" id="heading22">
                                                    <button class="btn btn-link collapsed" data-toggle="collapse"
                                                        data-target="#collapseMaps{{ $no }}"
                                                        aria-expanded="false" aria-controls="collapse2">
                                                        <h5 class="m-b-0">Maps</h5>
                                                    </button>
                                                </a>
                                                <div id="collapseMaps{{ $no }}" class="collapse"
                                                    aria-labelledby="heading22" data-parent="#accordian-3" style="">
                                                    <div class="card-body">
                                    ...
                                    <td>
                                        @if (
                                            $user->kategori == 'Pengawas' ||
                                                $user->kategori == 'Pendamping' ||
                                                $user->kategori == 'AdminTeknik' ||
                                                $user->kategori == 'SuperAdmin')
                                            @if ($checklist->status_checklist == 'terkunci')
                                            @else
                                                <a href="{{ route('editChecklist.admin', [$getProjek->nama_projek, Crypt::encrypt($checklist->id_rumah), Crypt::encrypt($checklist->termin_job), Crypt::encrypt($checklist->id_checklist)]) }}"
                                                    class="btn btn-outline-info"> <i class="fas fa-edit    "></i>
                                        ...
                                        @if ($checklist->foto != null)
                                            <button type="button" class="btn btn-outline-info" data-toggle="modal"
                                                data-target="#seeImage{{ $checklist->id_checklist }}">
                                                <i class="fas fa-image    "></i>
                                            </button>

                                            <!-- Modal -->
                                            <div class="modal fade" id="seeImage{{ $checklist->id_checklist }}"
                                                tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                                                aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="exampleModalLabel">Checklist
                                                                {{ $checklist->nama_jl }}</h5>
                                                        ...
                                                        <div class="modal-body">
                                                            <img id="imagePreview" style="width: 100%"
                                                                src="{{ asset('Home/images/termin/' . $checklist->foto) }}"
