@extends('V_Admin.app')
@extends('flashdata')
@section('title', 'Form One | Laporan Harian Taman')
@section('pageTitle', 'Laporan Harian Taman')
@section('back', route('tamanREM.admin', [$getProjek->nama_projek]))
            ...
            <div class="card">
                <a class="card-header" id="heading11">
                    <button class="btn btn-link" data-toggle="collapse" data-target="#harianLampu" aria-expanded="true" aria-controls="collapse1">
                        <h5 class="m-b-0">Laporan Taman Hari ini</h5>
                    </button>
                </a>
                <div id="harianLampu" class="collapse show" aria-labelledby="heading11" data-parent="#accordian-3">
                    <div class="card-body" >
                        <center><a href="" class="btn btn-outline-info"><i class="fa fa-plus" aria-hidden="true"></i> Laporan Taman Hari ini</a></center>
                    </div>
                </div>
            </div>
            ...
            <div class="card">
                <a class="card-header" id="heading11">
                    <button class="btn btn-link" data-toggle="collapse" data-target="#Lampu" aria-expanded="true" aria-controls="collapse1">
                        <h5 class="m-b-0">Laporan Taman</h5>
                    </button>
                </a>
                <div id="Lampu" class="collapse" aria-labelledby="heading11" data-parent="#accordian-3">
                    <div class="card-body" >
                        <table class="table " style="width: 100%" id="tableLampu">
                            <thead>
                                <tr>
                                    <th>No</th>
                            ...
                            <tbody>
                                @php
                                    $no=1
                                @endphp
                                @foreach ($getTamanREM as $lampuTaman)
                                <tr>
                                    <td>{{ $no }}</td>
