                                ...
                                @foreach ($getTipeRumah as $tipeRumah)
                                    <tr>
                                        ...
                                        <td>{{ $tipeRumah->jenis_tr }} &nbsp;
                                            ...
                                            @else
                                            <button type="button" class="btn btn-info" data-target="#order-information{{ $no }}" data-toggle="modal"
                                            data-target=".bd-example-modal-lg{{ $no }}"> <i class="fa fa-image"
                                                aria-hidden="true"></i><span class="badge badge-pill badge-info">
                                                {{ $tipeRumah->countGambar }}</span></button>
                                            @endif


                                            <div class="modal modal-form fade" id="order-information{{ $no }}" data-backdrop="static" data-keyboard="false"
                                            tabindex="-1" aria-labelledby="order-informationLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-lg modal-dialog-centered">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title">Gambar Tipe Rumah {{ $tipeRumah->jenis_tr }}</h5>
