            ...
            <div class="login-content">
                ...
                <form method="POST" action="{{ route('login.action') }}">
                    ...
                    <div class="forms">
                        ...
                        <!--</div>-->
                        <button href="/profile-setting.html" type="submit"
                            class="btn btn-primary w-100 mb-5 mb-lg-3">Sign
                            In</button>
                        ...
                        <p class="mb-0 light-grey-color">Belum mempunyai Akun? <a href="/sign-up"
                                style="font-size:20px;color:blue;">Sign Up</a> </p>
