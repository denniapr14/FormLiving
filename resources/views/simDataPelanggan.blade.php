...
@section('content')
                                ...
                                <form
                                    ...
                                    <div class="row form-order">
                                        ...
                                        <div class="btn-groups">
                                            <a href="/simulation-detail-type/{{ $rumah->id_rumah }}/{{ $tipeRumah->id_tipe_rumah }}"
                                                type="button" class="btn btn-grey">Kembali</a>
                                            <button type="submit" value="submit" id="submit" style="opacity: 20%"
                                                disabled="true" class="btn btn-primary">Lanjutkan</button>
    ...
    <script>
        $('#cariPromo').click(function() {
            ...
            $.ajax({
                url: '/simulation-data-pelanggan/cariKuponSpesial/{id_rumah}/{id_tipe}/{id_kkpr}/{jenis}/' +
                    kodePromo,
                type: 'GET',
                ...
                success: function(response) {
                    ...
                    if (response.length == 1) {
                        ...
                        for (var i = 0; i < len; i++) {
                            ...
                            spaceAlert.innerHTML = '<div class="alert alert-success">' + promo +
