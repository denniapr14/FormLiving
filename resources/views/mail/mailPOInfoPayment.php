...
<body>
  <div id="wrapper">
    ...
    <div class="one-col" style="background-color:white;">
      <h2 style="text-align: center;">Pemberitahuan kepada Departemen Accounting</h2>
      <p style="margin-left: 5%">Berikut data pre-order yang telah dipesan pada Formsliving untuk dikonfirmasi
        pembayaran</p>
      <br>
      <div class="container">
    ...
    <div class="one-col" style="padding-bottom: 4%; background-color : white;">
      <p>dimohon untuk konfirmasi pada aplikasi Formsliving anda</p>
    </div>
    <footer>
