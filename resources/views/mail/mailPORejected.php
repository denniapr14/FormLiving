...
<body>
    <div id="wrapper">
        ...
        <div class="one-col" style="background-color:white;">
            <h2 style="text-align: center;">Mohon Maaf</h2>
            <p style="margin-left: 5%">Data pre-order yang telah dipesan pada Formsliving</p>
            <br>
            <div class="container">
        ...
        <div class="one-col" style="padding-bottom: 4%; background-color : white;">
            ...
            <h3 style="text-align:center;">
                Bahwa Data Pre-Order telah ditolak dan tidak dapat digunakan, bilamana Anda masih ingin memesan unit
                ini,
                Anda bisa menghubungi Sales /Agent Kami untuk Pre-Order Ulang.
            </h3>
