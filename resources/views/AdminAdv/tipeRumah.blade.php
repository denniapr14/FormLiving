                ...
                <div class="card__box">
                    ...
                    <div class="card__header">
                        <div class="card__title">
                            ...
                            <h1>Tipe Rumah {{ $getRumah->nama_cluster }} / {{ $getRumah->blok }} - {{ $getRumah->nomor }} </h1>

                        </div>
                        <div class="invoices__actions">
                            <a href="/AdminADV/tambah-tipe-rumah/{{ $getRumah->id_rumah }}" class="btn-fd-outline btn--small">Tambah Tipe Rumah</a>
                        </div>
                    </div>
                        ...
                        <table id="formulirPesanan" class="table">
                            ...
                            <tbody>
                                ...
                                @foreach ($getTipeRumah as $tipeRumah)
                                    <tr>
                                        <td>{{ $no++ }}</td>
                                        <td>{{ $tipeRumah->jenis_tr }} m<sup>2</sup></td>
                                        <td>{{ $tipeRumah->luas_bangunan_tr }} m<sup>2</sup></td>
                                        <td>{{ rupiah($tipeRumah->harga_tr) }}</td>
                                        <td>
                                            <div class="d-flex flex-nowrap">
                                                <a href="/AdminADV/tipe-rumah/edit/{{ $tipeRumah->id_tipe_rumah }}" data-toggle="tooltip" data-placement="top" title="Ubah Tipe Rumah" class="btn-fd-icon-outline">
                                                    <i class="fa fa-edit" aria-hidden="true"></i>
                                                </a>
                                                <a href="/AdminADV/gambar-tipe-rumah/{{ $tipeRumah->id_tipe_rumah  }}" data-toggle="tooltip" data-placement="top" title="List Gambar Rumah" class="btn-fd-icon-outline">
