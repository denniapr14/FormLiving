...
<br>
                    <div class="card__header">
                        <div class="card__title">
                            ...
                            <h1>Tambah Gambar Tipe Rumah {{ $getRumah->nama_cluster }} / {{ $getRumah->blok }} - {{ $getRumah->nomor }} </h1>
                 ...
                 <div class="form-group">
                   ...
                   <div class="form-group">
                     ...
                     <input type="file" class="form-control-file" name="gambar"  onchange="previewImage()" id="image" placeholder="" aria-describedby="fileHelpId">
