          ...
          <div class="col-md-12">
            <div class="row">
              <div class="col-md-12">
                ...
                <div class="float-right" style="display: inline; width: 30%;">
                  <table class="table table-borderless">
                    <tr>
                      <td>No : </td>
                      <td><input type="text" class="myinput" name="no_fp" value=" {{ $fp->no_fp }} ">
                      </td>
                    </tr>
                  </table>
                </div>
              ...
              <h6>Yang bertanda tangan dibawah ini :
                <input id="getPelanggan" class="noprint" name="pelanggan" hidden value="<?= $fp->id_pelanggan ?>">
              </h6>
              <div class="col-md-12">
                  ...
                  <tbody>
                    <tr style="height: 5px; padding:2px;">
                      ...
                      <td class="text-left" style="width: 27%;">
                        <input type="text" name="nama" style="width: 90%;" id="nama_pelanggan" class="myinput "
                          value="<?= $fp->nama_plgn ?>" placeholder="Masukan Nama" aria-describedby="helpId">
                      </td>
                      <td class="text-left" style="width: 14%;vertical-align: middle;">Pekerjaan</td>
                      <td style="width: 1%;">:</td>
                      <td class="text-left " style="width:30% ;">
                        <input type="text" name="pekerjaan" style="width: 90%;" id="pekerjaan_pelanggan"
                          value="<?= $fp->pekerjaan_plgn ?>" class="myinput" placeholder="Masukan Pekerjaan"
                    ...
                    <tr>
                      ...
                      <td>:</td>
                      <td class="text-left">
                        <input type="text" name="ktp" style="width: 90%;" id="no_ktp_pelanggan" class="myinput "
                          value="<?= $fp->no_ktp_plgn ?>" placeholder="Masukan Nomor KTP" aria-describedby="helpId">
                      </td>
                      <td class="text-left">No. Telepon</td>
                      <td>:</td>
                      <td class="text-left ">
                        <input type="text" name="telp" style="width: 90%;" id="no_telp_pelanggan"
                          value="<?= $fp->no_telp_plgn ?>" class="myinput " placeholder="Masukan Nomor Telepon"
                          aria-describedby="helpId">
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td>:</td>
                      <td class="text-left ">
                        <input type="text" name="kelamin" style="width: 90%;" id="jenis_kelamin_pelanggan"
                          value="<?= $fp->jenis_kelamin_status ?>" class="myinput "
                          placeholder="Masukan Jenis Kelamin / Status" aria-describedby="helpId">
                      </td>

                      <td class="text-left">Email</td>
                      <td>:</td>
                      <td colspan="20" class="text-left ">
                        <input type="text" name="email" style="width: 90%;" id="email_pelanggan" class="myinput "
                          value="<?= $fp->email_plgn ?>" placeholder="Masukan Email" aria-describedby="helpId">
                      </td>
                    </tr>
                    <tr>
              ...
              <div class="col-md-12">
                <table class="table no-border" style="table-layout: fixed;">
                  ...
                  <tr>
                    ...
                    <td class="text-left">:
                      &nbsp; <span id="textHarga1" style="font-weight:bold;">
                        <?= rupiah($fp->total_harga) ?></span>
                      <input type="text" readonly hidden name="harga" id="harga"
                        onclick="terbilangSet('harga', 'terbilang')" style="width: 40%;" id="" value="" class="myinput"
                  ...
                  <tr>
                    ...
                    <td class="text-left" colspan="2" id="">: &nbsp;<input type="text" name="terisi" id="terisi"
                        readonly value="<?= $fp->terbilang ?>" style="width: 95%;">
                    </td>
                  </tr>
                </table>
              </div>
              ...
              <div class="col-md-12">
                <div class="row">
                  <div class="col-md-6">
                    <table class="table no-border" style="table-layout:fixed; width: 100%;">
                      <tr>
                        ...
                        <td class="text-left ">: &nbsp; <span style="font-weight:bold;" id="textHarga2">
                            <?= rupiah($fp->harga_awal) ?></span> <br>
                          <input type="number" value="<?= $fp->harga_awal ?>" name="harga" style="width:50%;"
                            onkeyup="return convertToRupiah(this.value, 'textHarga1','textHarga2')" id="inputHarga"
                            class="myinput no-print" placeholder="Masukan harga" aria-describedby="helpId">
                        </td>
                      </tr>
                      <tr>
                        <td class="text-left">Diskon</td>
                        <td class="text-left">: &nbsp; <span style="font-weight:bold;" id="textDiskon">
                            <?= rupiah($fp->total_diskon) ?></span> <br>
                          <input type="number" value="<?= $fp->total_diskon ?>" name="diskon" style="width: 50%;"
                            onkeyup="return convertToRupiah(this.value, 'textDiskon')" id="inputDiskon"
                            class="myinput no-print" placeholder="Masukan diskon" aria-describedby="helpId">
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td class="text-left">:
                          &nbsp; <span style="font-weight:bold;" id="textTotHarga">
                            <?= rupiah($fp->total_harga) ?></span> <br>
                          <input type="number" id="totalharga" value="<?= $fp->total_harga ?>" name="total"
                            style="width: 50%;" onkeyup="return convertToRupiah(this.value, 'textTotHarga')"
                            class="myinput no-print" placeholder="Masukan diskon" aria-describedby="helpId">
                      ...
                      <tr>
                        ...
                        <td class="text-left">: &nbsp; <span style="font-weight:bold;" id="textDP">
                            <?= rupiah($fp->uang_muka) ?></span> <br>
                          <input type="number" value="<?= $fp->uang_muka ?>" name="dp" style="width: 50%;"
                            onkeyup="return convertToRupiah(this.value, 'textDP')" class="myinput no-print"
                  ...
                  <div class="col-md-4" style="border: 3px solid;">
                    ...
                    <table class="table no-border" style="table-layout:fixed; border:none !important">
                      <tr>
                ...
                <table class="table solid-border" style="table-layout:fixed;">
                 ...
                 <tbody style="border:1px solid black;">
                    <tr style="height:30px; border:1px solid black;" class="BDT">
                      <td style="width: 5%; border:1px solid black;"><?= $noDtl ?></td>
                      <td style="width: 40%; border:1px solid black; ">
                          <input type="hidden" name="id_dfp[]" value="<?= $dfp->id_dtl_fp ?>">
                        <input type="text" name="ket[]" class="myinput" value="<?= $dfp->ket_dfp ?>"
                          style="width: 100%;">
                      </td>
                       <td style="border:1px solid black;">
                      <input type="date" readonly class="myinput" name="notifDate[]" value="<?=$dfp->date_dfp?>">
                      </td>
                      <td style="border:1px solid black;"> <input type="text" name="notifHarga[]" class="myinput"
                          value="<?= $dfp->harga_dfp ?>" style="width: 100%;"></td>
                    </tr>
                    <?php
                        $noDtl++;
                      }
                  ...
                  <div class="col-md-8">
                    <table class="table table-bordered">
                      <tr>
                        ...
                        <td style="width: 100%;"> <input type="text" name="sudahT" class="myinput"
                            value="<?= $fp->sdh_termasuk_fp ?>" style="width: 100%;">
                        </td>
                      </tr>
                      <tr>
                        <td>Belum Termasuk</td>
                        <td> <input type="text" name="belumT" value="<?= $fp->blm_termasuk_fp ?>" class="myinput"
                            style="width: 100%;">
                        </td>
                      </tr>
                    </table>
